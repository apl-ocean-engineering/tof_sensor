...
class ImageFusion {
  ...
  ros::Publisher color_pub =
      n.advertise<colorPointCloud>("image_fusion/color_pointcloud", 1);
  ros::Publisher image_pub_ =
      n.advertise<sensor_msgs::Image>("projected_image", 30);
...
void ImageFusion::pointcloud_callback(
    const boost::shared_ptr<const sensor_msgs::PointCloud2> &input) {
  /**************************************************************************
  ...
  **************************************************************************/
  ...
  // Loop through all points in pointcloud to create large homogeneous 'X'
  // matrix
...
void ImageFusion::img_info_callback(
